...
function renderPlate(){
  const host=document.getElementById('p-plate');
  if(!host) return;
  host.innerHTML = `
...
function renderInfo(){
  ...
  <div class="fact"><h3>Бюджет месяца</h3>
    <ul><li>Личные суммы в этой сборке не хранятся. Бюджет на еду задаётся кнопками выше и сохраняется только на твоём устройстве.</li></ul>
  </div>
